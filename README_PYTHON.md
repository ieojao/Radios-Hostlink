# Nova Atalaia - Rádio Web (Versão Python)

Este é o projeto da rádio web Nova Atalaia convertido para Python usando Flask. Uma aplicação web moderna para gerenciar e exibir programação de rádio gospel.
...
SITE_EMAIL=contato@novaatalaia.com.br
...
Este projeto foi convertido do PHP para Python. Principais mudanças:

### Vantagens da Versão Python
- **Performance**: Flask é mais rápido que PHP
- **Segurança**: Melhor gerenciamento de dependências
- **Manutenibilidade**: Código mais limpo e organizado
- **Escalabilidade**: Mais fácil de escalar
- **Deploy**: Mais opções de hospedagem

### Funcionalidades Mantidas
- Todas as funcionalidades do PHP
- Interface idêntica
